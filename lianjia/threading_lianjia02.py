...
headers = {
        "Host": "hz.lianjia.com",
        "Referer": "https://hz.lianjia.com/ershoufang/linping/",
...
def get_house(page):
    if page == 1:
        url = "https://hz.lianjia.com/ershoufang/linping/"
    else:
        url = f"https://hz.lianjia.com/ershoufang/linping/pg{page}/"
